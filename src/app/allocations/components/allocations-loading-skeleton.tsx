			...
			<PageContent>
				<div className="flex flex-col lg:flex-row gap-6">
					<div className="flex-1 lg:flex-[3] flex flex-col gap-6">
						...
						<div className="rounded-xl border bg-card text-card-foreground shadow h-[400px] p-6">
					...
					<div className="lg:flex-[1]">
						...
						<div className="rounded-xl border bg-card text-card-foreground shadow h-[400px] p-6 flex items-center justify-center">
