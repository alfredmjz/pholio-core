        ...
        <div className="flex items-center justify-between p-4 hover:bg-muted/30 transition-colors group">
            ...
            <div className="flex items-center gap-6 md:gap-8">
                <div className="flex flex-col items-end">
                     ...
                     <div className={cn("flex items-center gap-1.5 text-xs", isPastDue ? "text-error font-medium" : "text-muted-foreground")}>
                ...
                <div className="hidden md:block">
                     <StatusBadge status={bill.status || (isPastDue ? 'overdue' : 'upcoming')} />
                </div>
