		...
		<Card>
			...
			<CardContent className="space-y-6">
				...
				<div className="space-y-2">
					<Label htmlFor="fullName">{profile?.is_guest ? "Display Name" : "Full Name"}</Label>
					{!isEditingName ? (
						<div
							className={cn(
						...
						<div className="space-y-3">
							...
							<div className="flex gap-2">
								<Button size="sm" onClick={handleNameSave} disabled={isPending || !nameValue.trim()}>
									{isPending ? "Saving..." : "Save"}
								</Button>
								<Button size="sm" variant="outline" onClick={handleNameCancel} disabled={isPending}>
									Cancel
								</Button>
							</div>
						</div>
